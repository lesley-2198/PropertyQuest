...
- Create Angular project with ng: `ng new propertyquest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`propertyquest.client.esproj`).
